...
<template>
  <article class="page page--narrow prose">
    ...
    <p>
      Доступны четыре критерия: расстояние Бхаттачарьи, расстояние
      Махаланобиса, взаимная информация и отбор через классификатор
      ближайших соседей. Первые три не зависят от какой-либо модели
      и считаются за секунды, последний обучает классификатор
      и работает заметно дольше.
    </p>
    <p>
